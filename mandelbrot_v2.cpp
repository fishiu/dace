...
inline void mandelbrot_17_4_0_0_2(mandelbrot_t *__state, const long long&  __tmp_23_53_r, unsigned short&  __tmp_29_8_w, int H, int W, long long px, long long py) {
    ...
    #pragma omp single
    {
        /* Calculate xtemp */
        {
            #pragma omp task shared(__tmp18) depend(out: __tmp18)
            {
                double __in1 = x;
                double __in2 = x;
                double __out;
            ...
            #pragma omp task shared(__tmp19) depend(out: __tmp19)
            {
                double __in1 = y;
                double __in2 = y;
                double __out;
            ...
            #pragma omp task shared(__tmp18, __tmp19, __tmp20) depend(in: __tmp18, __tmp19) depend(out: __tmp20)
            {
            ...
            #pragma omp task shared(__tmp20, xtemp) depend(in: __tmp20) depend(out: xtemp)
            {
                double __in2 = x0;
        ...
        /* Calculate new y */
        {
            #pragma omp task shared(__tmp22) depend(out: __tmp22)
            {
                double __in2 = x;
                double __out;
            ...
            #pragma omp task shared(__tmp22, __tmp23) depend(in: __tmp22) depend(out: __tmp23)
            {
            ...
            #pragma omp task shared(__tmp23, __tmp24) depend(in: __tmp23) depend(out: __tmp24)
            {
                double __in2 = y0;
            ...
            #pragma omp task shared(__tmp24) depend(in: __tmp24) depend(out: y)
            {
        ...
        /* Calculate new x */
        {
            #pragma omp task depend(in: xtemp) depend(out: x)
            {
                double __inp = xtemp;
                double __out;
